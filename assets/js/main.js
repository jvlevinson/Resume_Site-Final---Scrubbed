// Initialize SweetScroll or any other global initializations
document.addEventListener("DOMContentLoaded", function () {
    new SweetScroll({});

    // Hero particles initialization targeting the hero section
    ...
    // Footer particles initialization targeting the footer section
    particlesJS("footer-particles-js", {
        particles: {
            ...
            line_linked: { enable: false, distance: 150, color: "#ffffff", opacity: 0.4, width: 1 },
            move: { enable: true, speed: 0.6, direction: "none", random: true, straight: false, out_mode: "out", bounce: false, attract: { enable: false, rotateX: 600, rotateY: 1200 } }
        },
        interactivity: {
            detect_on: "canvas",
            events: {
